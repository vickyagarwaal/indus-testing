<ul class="nav">
    ...
    <li class="nav-item">
        <a data-toggle="collapse" href="#items">
            ...
            <p>{{ __('Manage TimesQuartz Products') }}</p>
            <span class="caret"></span>
        </a>
        <div class="collapse" id="items">
            <ul class="nav nav-collapse">
                ...
                <li>
                    <a class="sub-link" href="{{ url('admin/item/create') }}">
           ...
           <ul class="nav nav-collapse">
                ...
                <li>
                    <a  class="sub-link" href="{{ route('back.slider.index') }}">
                        <span class="sub-item">{{ __('Sliders/Banners') }}</span>
                    </a>
                </li>
                ...
                <li>
                    ...
                    <a class="sub-link" href="{{ route('back.setting.maintainance') }}">
                      <span class="sub-item">{{ __('Maintenance') }}</span></a>
                </li>
                <li>
