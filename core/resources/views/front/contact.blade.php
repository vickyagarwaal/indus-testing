      ...
      <div class="col-lg-4 col-md-5 col-sm-5 order-lg-1 order-md-2 order-sm-2">
        ...
        <section class="widget widget-featured-posts card rounded p-4 ">
          ...
          <ul class="list-unstyled text-sm">
            ...
            <li><span class="text-muted">{{__('Monday-Saturday')}}:</span>{{$setting->friday_start}} - {{$setting->friday_end}}</li>
            <li><span class="text-muted">{{__('Sunday')}}:</span>{{$setting->satureday_start}} - {{$setting->satureday_end}}</li>
          </ul>
