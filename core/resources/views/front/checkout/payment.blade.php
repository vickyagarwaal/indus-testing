        ...
        <div class="row padding-top-1x  mb-4">
          <div class="col-sm-6">
            ...
            <ul class="list-unstyled">
              <li><span class="text-muted">Shop Name: </span>{{$ship['ship_first_name']}} -{{$ship['ship_last_name']}}</li>
          ...
          <div class="col-sm-6">
            ...
            <ul class="list-unstyled">
              <li><span class="text-muted">Shop Name:: </span>{{$bill['bill_first_name']}} {{$bill['bill_last_name']}}</li>
              @if (PriceHelper::CheckDigital())
              <li><span class="text-muted">{{__('Address')}}: </span>{{$ship['ship_address1']}} {{$ship['ship_address2']}}</li>
              @endif
