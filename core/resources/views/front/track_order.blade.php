...
<div class="page-title">
    ...
    <div class="container py-5">
        <div class="row justify-content-center py-5 box_shoadow_track">

            <div class="col-lg-6">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="input-group">
                            <input class="form-control" type="text" id="order_number" name="order_number" placeholder="{{ __('Order Number') }}" required>
