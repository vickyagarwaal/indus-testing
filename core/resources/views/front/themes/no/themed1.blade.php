    ...
    @endif
        <section class="selected-product-section featured_cat_sec sps-two mt-50">
            <div class="container">
                ...
                <div class="row g-3" id="feature_category_viewh">
                    @foreach ($category_vkis as $category_vkis)
                    <div class="col-gd">
                        <div class="product-card">
                            <div class="product-thumb" >
                                    ...
                                    <img class="lazy" data-src="{{asset('assets/images/'.$category_vkis->photo)}}" alt="Product">
                                   
                            </div>
                            <div class="product-card-body">
                                <div class="product-category"></div>
                                <h3 class="product-title product_vki"><a href="{{route('front.catalog').'?category='.$category_vkis->slug}}">
                                    {{ strlen(strip_tags($category_vkis->name)) > 35 ? substr(strip_tags($category_vkis->name), 0, 35) : strip_tags($category_vkis->name) }}
                                </a></h3>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title">
                            <h2 class="h3">{{ $feature_category_title }} Products</h2>
                            <div class="links">
