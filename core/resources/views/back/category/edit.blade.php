					...
					<div class="row justify-content-center">
						<div class="col-lg-12">
								<form class="admin-form" action="{{ route('back.category.update',$category->id) }}"
									...
									<div class="form-group">
										...
										<br>
											<img class="admin-img"
												...
												alt="No Image Found">
                                        <br>
										<span class="mt-1">{{ __('Image Size Should Be 320 x 320.') }}</span>
									</div>
                                  ...
                                  <!--  <div class="form-group">
										<label for="name">{{ __('Current Small Image') }} *</label>
										<br>
											<img class="admin-img"
												src="{{ $category->small_photo ? asset('assets/images/'.$category->small_photo) : asset('assets/images/placeholder.png') }}"
												alt="No Image Found">
                                        <br>
										<span class="mt-1">{{ __('Image Size Should Be 40 x 40.') }}</span>
									</div>
