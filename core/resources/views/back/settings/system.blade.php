                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-lg-12 pb-1">
                                                                                <img class="admin-setting-img my-mw-100"
                                                                                    src="{{ $setting->discount_banner ? asset('assets/images/'.$setting->discount_banner) : asset('assets/images/placeholder.png') }}"
                                                                                    alt="No Image Found">
                                                                            </div>
                                                                            <span>{{ __('Image Size Should Be 1400 x 460 Pixel') }}</span>
                                                                        </div>
                                                                ...
                                                                <div class="row justify-content-center">
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-lg-12 pb-1">
                                                                                <img class="admin-setting-img my-mw-100"
                                                                                    src="{{ $setting->percent_off ? asset('assets/images/'.$setting->percent_off) : asset('assets/images/placeholder.png') }}"
                                                                                    alt="No Image Found">
                                                                            </div>
                                                                            <span>{{ __('Image Size Should Be 1450 x 680 Pixel') }}</span>
                                                                        </div>
                                                                ...
                                                                <div class="row justify-content-center">
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-lg-12 pb-1">
                                                                                <img class="admin-setting-img my-mw-100"
                                                                                    src="{{ $setting->why_us ? asset('assets/images/'.$setting->why_us) : asset('assets/images/placeholder.png') }}"
                                                                                    alt="No Image Found">
                                                                            </div>
                                                                            <span>{{ __('Image Size Should Be 1200 x 210 Pixel') }}</span>
                                                                        </div>
