    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="d-sm-flex align-items-center justify-content-between">
                <h3 class="mb-0 bc-title"><b><?php echo e(__('Add User')); ?></b> </h3>
			...
			<div class="card o-hidden border-0 shadow-lg">
				<div class="card-body ">
					...
					<div class="row justify-content-center">
						<div class="col-lg-12">
								<form class="admin-form" action="<?php echo e(route('back.staff.store')); ?>" method="POST" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<br>
											<img class="admin-img"
												src="<?php echo e(asset('assets/images/placeholder.png')); ?>"
												alt="No Image Found">
										<br>
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/testingindus/core/resources/views/back/staff/create.blade.php ENDPATH**/ ?>