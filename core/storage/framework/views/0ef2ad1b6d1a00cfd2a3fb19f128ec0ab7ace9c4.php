                                                        ...
                                                        <?php if($pkey == 'paytm'): ?>
                                                            ...
                                                            <?php else: ?>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="inp-<?php echo e(__($pkey)); ?>" name="pkey[<?php echo e(__($pkey)); ?>]"  placeholder="<?php echo e(__( $paytm->name.' '.ucwords(str_replace('_',' ',$pkey)) )); ?>" value="<?php echo e($paytmData); ?>" >
                                                                </div>
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/testingindus/core/resources/views/back/settings/payment.blade.php ENDPATH**/ ?>