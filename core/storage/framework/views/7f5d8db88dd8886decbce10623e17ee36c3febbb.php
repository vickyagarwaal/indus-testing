			...
			<div class="card o-hidden border-0 shadow-lg">
				<div class="card-body ">
					...
					<div class="row justify-content-center">
						<div class="col-lg-12">
								<form class="admin-form" action="<?php echo e(route('back.code.store')); ?>" method="POST"
									...
									<div class="form-group">
										...
										<input type="text" name="code_name" class="form-control" id="code"
											placeholder="<?php echo e(__('Enter Code')); ?>" value="<?php echo e(old('code_name')); ?>" >
									</div>
									...
									<div class="form-group">
										...
										<input type="number" name="no_of_times" class="form-control" id="no_of_times"
											placeholder="<?php echo e(__('Enter Number Of Times')); ?>" value="<?php echo e(old('no_of_times')); ?>" min="1" >
									</div>
                                            ...
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">
													<select name="type" class="form-control">
														...
														<option value="amount"><?php echo e(__('Amount')); ?> (<?php echo e(PriceHelper::adminCurrency()); ?>)</option>
													</select>
												</span>
                                            </div>
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/indusrise/core/resources/views/back/code/create.blade.php ENDPATH**/ ?>