...
class CategoryRepository
{
    ...
    public function store($request)
    {
      ...
      //  $input['small_photo'] = ImageHelper::handleUploadedImage($request->file('small_photo'),'assets/images');
    ...
    public function update($category, $request)
    {
      ...
      /*  if ($file = $request->file('small_photo')) {
         $input['small_photo'] = ImageHelper::handleUpdatedUploadedImage($file,'/assets/images/',$category,'/assets/images/','small_photo');
