        ...
        if(isset($this->is_validate)){
            return [
                ...
                'favicon' => 'mimes:jpeg,jpg,png,svg,ico',
                                ...
                                'discount_banner' => 'mimes:jpeg,jpg,png,webp',
                                'percent_off' => 'mimes:jpeg,jpg,png,webp',
                                'why_us' => 'mimes:jpeg,jpg,png,webp',
    ...
    public function messages()
    {
        return [
            'logo.mimes'    => __('Logo Image type must be jpg,jpeg,png,svg.'),
                        ...
                        'discount_banner.mimes'    => __('Logo Image type must be jpg,jpeg,png,webp'),
                        'percent_off.mimes'    => __('Logo Image type must be jpg,jpeg,png,webp'),
                                                'why_us.mimes'    => __('Logo Image type must be jpg,jpeg,png,webp'),
