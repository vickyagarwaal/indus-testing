    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::group(['middleware' => 'permissions:Manages Pages'], function () {
            ...
            Route::resource('page', 'Back\PageController', ['as' => 'back', 'except' => 'show']);
                        ...
                        Route::get('testimonials', 'Back\TestimonialsController@index')->name('back.testimonials.index');
                       Route::get('add/testimonials', 'Back\TestimonialsController@add')->name('back.testimonials.add');
...
Route::group(['middleware' => 'maintainance'], function () {
    Route::group(['middleware' => 'localize'], function () {
        ...
        //------------ CATALOG ------------
        Route::get('/products', 'Front\CatalogController@index')->name('front.catalog');
